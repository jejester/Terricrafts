...
function MainProductImages(){
    return(
        <>
            <div className="image-showcase flex-col lg:flex-row relative flex items-center justify-center product-group px-20 mt lg:mt-28 overflow-hidden xl:overflow-visible">
                ...
                <div className="main-tagline relative flex flex-col items-center lg:items-start justify-start text-balance flex-1 mt-5 px-1 mx-5 gap-5">
                    ...
                    <div className="absolute -z-50 -top-96 -right-60"> 
                        <img className="scale-50 opacity-85 dark:opacity-5" src="./images/decorations/worm.png" alt="" />                     
                    </div>
            </div>
        </>
    )
